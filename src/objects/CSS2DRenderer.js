				...
				if (object.isCSS2DObject) {
					...
					if (!object.visible) {
						...
						if (/apple/i.test(navigator.vendor)) {
							...
							style = 'translate(-50%,-100%) translate(' + Math.round(_vector.x * _widthHalf + _widthHalf) + 'px,' + Math.round(- _vector.y * _heightHalf + _heightHalf) + 'px)';

						} else {

							style = 'translate(-50%,-100%) translate(' + (_vector.x * _widthHalf + _widthHalf) + 'px,' + (- _vector.y * _heightHalf + _heightHalf) + 'px)';
						}
